...
struct wpa_driver_ops {
	...
	void * (*hapd_init)(struct hostapd_data *hapd,
			    struct wpa_init_params *params,nl_recv_callback call_func);
...
//初始化并分配内存global 结构体,在这里初始化与nl802.11层的 netlink连接
...
static int nl80211_init_bss(struct i802_bss *bss,nl_recv_callback call_func)
{
...
static void * wpa_driver_nl80211_drv_init(void *ctx, const char *ifname,
					  ...
					  const u8 *set_addr, nl_recv_callback call_func)
{
	struct wpa_driver_nl80211_data *drv;
	//struct rfkill_config *rcfg;
	struct i802_bss *bss;
	
	//wpa_printf(MSG_ERROR, "wpa_driver_nl80211_drv_init 0000 to init\n");
	if (global_priv == NULL)
		return NULL;
	//drv内存分配
	...
	if (nl80211_init_bss(bss,call_func))
		goto failed;	
...
//const struct wpa_driver_ops wpa_driver_nl80211_ops = {
 static struct wpa_driver_ops wpa_driver_nl80211_ops = {
	.name = "nl80211",
...
static struct wpa_driver_ops *wpa_drivers[] =
{
