...
#ifdef LIBEVENT2_MGMT_FRAME
    
    /**
     * get_mgmt_socket_fd - get the socket fd of management frame.
     * @priv: private driver interface data from init()
     * Returns: 0 on success, -1 on failure
     */
    int (*get_mgmt_socket_fd)(void *priv);
    
    /**
     * recv_mgmt_frame - receive the management frame.
     * @priv: private driver interface data from init()
     * Returns: 0 on success, -1 on failure
     */
